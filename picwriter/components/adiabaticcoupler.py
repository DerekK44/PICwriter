...
class AdiabaticCoupler(gdspy.Cell):
    ...
    def __build_cell(self):
        ...
        wg_top2.turn(self.wgt.bend_radius, p*self.angle, number_of_points=0.1, **self.wg_spec)
        wg_top2.turn(self.wgt.bend_radius, -p*self.angle, number_of_points=0.1, final_width=self.wgt.wg_width, **self.wg_spec)
        ...
        wg_bot2.turn(self.wgt.bend_radius, -p*self.angle, number_of_points=0.1, **self.wg_spec)
        wg_bot2.turn(self.wgt.bend_radius, +p*self.angle, number_of_points=0.1, final_width=self.wgt.wg_width, **self.wg_spec)
